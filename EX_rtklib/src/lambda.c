...
static int LD(int n, const double *Q, double *L, double *D)
{
	...
	trace(4, "D=\n"); tracemat(4, D, n, 1, 10, 3);//²âÊÔ
	trace(4, "L=\n"); tracemat(4, L, n, n, 10, 3);//²âÊÔ
    free(A);
                  ...
                  double *s)
{
    ...
    if (!(info=LD(n,Q,L,D))) {
        ...
        /* lambda reduction */
        reduction(n,L,D,Z);
		//if (Q) { trace(1, "Q=\n"); tracemat(1, Q, n, n, 7, 4); }//²âÊÔ
        matmul("TN",n,1,n,1.0,Z,a,0.0,z); /* z=Z'*a */
		//matmul("TN",n,n,n,1.0,Z,Q,0.0,Qn1);
		//matmul("NN",n,n,n,1.0,Qn1,Z,0.0,Qn);//²âÊÔ
		//if (Qn) { trace(1, "Qn=\n"); tracemat(1, Qn, n, n, 7, 4); }//²âÊÔ
